      ...
      .replace(
        ...
        '<div class="utility-topology" aria-label="Utility service layout">' +
          ...
          '<div class="utility-topology-grid">' +
            ...
            '<div class="utility-topology-item"><div class="utility-topology-icon">🚽</div><div class="utility-topology-copy"><div class="utility-topology-title"><b>Sewer</b><span class="utility-count">2 accounts</span></div><p><strong>Main house</strong> has its own sewer service. The <strong>guest-house sewer line</strong> is separate and is shared with the office/shop.</p></div></div>' +
